all:
	...
	avr-gcc -mmcu=atmega32u4 -Wl,-Map=EVK527-ATMega32U4-usbdevice_cdc.map,--cref,--gc-sections,--relax default/usb_descriptors.o default/usb_drv.o default/usb_specific_request.o default/main.o default/usb_standard_request.o default/flash_drv.o    -o EVK527-ATMega32U4-usbdevice_cdc.elf
