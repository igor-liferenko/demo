all:
	...
	avr-gcc -mmcu=atmega32u4 -Wall -gdwarf-2 -Os -fsigned-char -ffunction-sections -ffunction-sections -MD -MP -MT default/scheduler.o -MF default/dep/scheduler.o.d  -c scheduler.c -o default/scheduler.o
	avr-gcc -mmcu=atmega32u4 -Wall -gdwarf-2 -Os -fsigned-char -ffunction-sections -ffunction-sections -MD -MP -MT default/cdc_task.o -MF default/dep/cdc_task.o.d  -c cdc_task.c -o default/cdc_task.o
	...
	avr-gcc -mmcu=atmega32u4 -Wl,-Map=EVK527-ATMega32U4-usbdevice_cdc.map,--cref,--gc-sections,--relax default/start_boot.o default/uart_lib.o default/uart_usb_lib.o default/usb_descriptors.o default/usb_device_task.o default/usb_drv.o default/usb_specific_request.o default/power_drv.o default/scheduler.o default/cdc_task.o default/main.o default/usb_standard_request.o default/flash_drv.o    -o EVK527-ATMega32U4-usbdevice_cdc.elf
